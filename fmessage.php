...
$sql = "select * from fboard where post_num = '$post_num';";
...
if($result){
    ...
    {
        if($row[imageUp] != null)
            echo "<tr><td colspan=2><img src='fuploads/$row[imageUp]' height='100px' width='200px'></td></tr>";
        echo $row[title];
    }
}
...
*/
if($row[id_one] == $row[writer]){
echo "<div class='container1'>";
echo  "<img src='/pics/avatarface.jpg' alt='Avatar'>";
echo "<span class='time-right'>$row[id_one]</span><br><br>";
...
echo "<span class='time-left'>$row[id_two]</span><br><br>";
echo  "<p>$row[message]</p><br><br>";
...
?>
    ...
    <a href="fboard_read.php?num=<? echo $post_num ?>"><button class="btn4" >Article</button></a>
</div>
